...
public class DocumentSource
{
    ...
    private readonly ElasticDatabaseWrapper _database;
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public DocumentSource(IEntityType entityType, ElasticDatabaseWrapper database)
    {
...
#pragma warning restore EF1001 // Internal EF Core API usage.
    ...
    private static JToken? ConvertPropertyValue(IProperty property, IUpdateEntry entry)
    {
        ...
        return value == null
            ? null
            : (value as JToken) ?? JToken.FromObject(value, ElasticClientWrapper.Serializer);
    }
}
