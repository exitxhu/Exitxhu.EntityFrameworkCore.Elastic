...
/// </remarks>
public static class ElasticModelExtensions
{
    /// <summary>
    ...
    public static string GetDefaultIndexName(this IReadOnlyModel model)
        => (string)model[CosmosAnnotationNames.IndexName];
    ...
    public static void SetDefaultIndexName(this IMutableModel model, string name)
    ...
    public static string SetDefaultIndexName(
    ...
    public static ConfigurationSource? GetDefaultIndexConfigurationSource(this IConventionModel model)
        => model.FindAnnotation(CosmosAnnotationNames.IndexName)?.GetConfigurationSource();
