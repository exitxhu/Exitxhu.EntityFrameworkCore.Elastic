...
public static class CosmosQueryableExtensions
{
    ...
    ///     <see cref="ElasticPage{T}.ContinuationToken" />. If <see langword="null" />, retrieves query results from the start.
    /// </param>
    /// <param name="pageSize">
    ///     The maximum number of results in the returned <see cref="ElasticPage{T}" />. The page may contain fewer results if the database
    ...
    /// <returns>A <see cref="ElasticPage{T}" /> containing at most <paramref name="pageSize" /> results.</returns>
    public static Task<ElasticPage<TSource>> ToPageAsync<TSource>(
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return provider.ExecuteAsync<Task<ElasticPage<TSource>>>(
            Expression.Call(
                instance: null,
