...
/// </remarks>
public static class ElasticEntityTypeExtensions
{
    /// <summary>
    ...
    public static string GetIndexName(this IReadOnlyEntityType entityType)
        => entityType.BaseType != null
            ? entityType.GetRootType().GetIndexName()
            : (string)entityType[CosmosAnnotationNames.IndexName]
                ?? GetDefaultIndex(entityType);

    private static string GetDefaultIndex(IReadOnlyEntityType entityType)
        => entityType.FindOwnership() != null
            ? null
            : entityType.Model.GetDefaultIndexName()
    ...
    public static void SetIndexName(this IMutableEntityType entityType, string name)
        => entityType.SetOrRemoveAnnotation(
            CosmosAnnotationNames.IndexName,
    ...
    public static string SetIndexName(
    ...
    public static ConfigurationSource? GetIndexConfigurationSource(this IConventionEntityType entityType)
        => entityType.FindAnnotation(CosmosAnnotationNames.IndexName)
