...
/// </summary>
public static class ElasticDatabaseFacadeExtensions
{
    /// <summary>
    ...
    public static ElasticsearchClient GetElasticClient(this DatabaseFacade databaseFacade)
        => GetService<ISingletonElasticClientWrapper>(databaseFacade).Client;
    ...
    public static bool IsElastic(this DatabaseFacade database)
        => database.ProviderName == typeof(ElasticOptionsExtension).Assembly.GetName().Name;
}
