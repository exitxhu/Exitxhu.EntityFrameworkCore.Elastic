...
public static class CosmosEntityTypeBuilderExtensions
{
    ...
    public static EntityTypeBuilder ToIndexName(
        this EntityTypeBuilder entityTypeBuilder,
        string name)
    {
        Check.NullButNotEmpty(name, nameof(name));

        entityTypeBuilder.Metadata.SetIndexName(name);
    ...
    /// <param name="name">The name of the container.</param>
    /// <returns>The same builder instance so that multiple calls can be chained.</returns>
    public static EntityTypeBuilder<TEntity> ToIndexName<TEntity>(
        this EntityTypeBuilder<TEntity> entityTypeBuilder,
        string name)
        where TEntity : class
        => (EntityTypeBuilder<TEntity>)((EntityTypeBuilder)entityTypeBuilder).ToIndexName(name);
    ...
    /// </returns>
    public static IConventionEntityTypeBuilder ToIndex(
        this IConventionEntityTypeBuilder entityTypeBuilder,
        string name,
        bool fromDataAnnotation = false)
    {
        if (!entityTypeBuilder.CanSetIndexName(name, fromDataAnnotation))
        {
            return null;
        }

        entityTypeBuilder.Metadata.SetIndexName(name, fromDataAnnotation);
    ...
    public static bool CanSetIndexName(
        this IConventionEntityTypeBuilder entityTypeBuilder,
        string name,
        bool fromDataAnnotation = false)
    {
        ...
        return entityTypeBuilder.CanSetAnnotation(CosmosAnnotationNames.IndexName, name, fromDataAnnotation);
    }
