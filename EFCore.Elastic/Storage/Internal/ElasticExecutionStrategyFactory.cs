...
/// </summary>
public class ElasticExecutionStrategyFactory : IExecutionStrategyFactory
{
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public ElasticExecutionStrategyFactory(ExecutionStrategyDependencies dependencies)
    {
        Dependencies = dependencies;

        _createExecutionStrategy = dependencies.Options.FindExtension<ElasticOptionsExtension>()?.ExecutionStrategyFactory
    ...
    protected virtual IExecutionStrategy CreateDefaultStrategy(ExecutionStrategyDependencies dependencies)
        => new ElasticExecutionStrategy(dependencies);
