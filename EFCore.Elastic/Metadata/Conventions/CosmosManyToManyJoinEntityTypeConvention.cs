    ...
    IEntityTypeAnnotationChangedConvention
{
    ...
    {
        if (name is CosmosAnnotationNames.PartitionKeyNames or CosmosAnnotationNames.IndexName)
        {
    ...
    private static bool ShouldSharePartitionKey(IConventionSkipNavigation skipNavigation)
        => skipNavigation.DeclaringEntityType.GetIndexName() == skipNavigation.TargetEntityType.GetIndexName()
