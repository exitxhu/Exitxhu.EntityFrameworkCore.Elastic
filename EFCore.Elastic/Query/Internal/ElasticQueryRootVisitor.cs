...
/// </summary>
public class ElasticQueryRootVisitor : QueryRootProcessor
{
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public ElasticQueryRootVisitor(QueryTranslationPreprocessorDependencies dependencies, QueryCompilationContext queryCompilationContext)
