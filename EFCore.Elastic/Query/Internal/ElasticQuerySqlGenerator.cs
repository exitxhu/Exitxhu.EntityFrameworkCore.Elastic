...
/// </summary>
public class ElasticQuerySqlGenerator(ITypeMappingSource typeMappingSource) : SqlExpressionVisitor
{
        ...
        switch (fromSqlExpression.Arguments)
        {
            ...
            default:
                throw new ArgumentOutOfRangeException(
                    ...
                    $"{fromSqlExpression.Arguments.GetType()}, {(fromSqlExpression.Arguments is ConstantExpression constantExpression
