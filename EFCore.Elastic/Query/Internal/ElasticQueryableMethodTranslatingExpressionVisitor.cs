...
/// </summary>
public class ElasticQueryableMethodTranslatingExpressionVisitor : QueryableMethodTranslatingExpressionVisitor
{
    ...
    private readonly ElasticQueryCompilationContext _queryCompilationContext;
    ...
    private readonly ElasticAliasManager _aliasManager;
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public ElasticQueryableMethodTranslatingExpressionVisitor(
        QueryableMethodTranslatingExpressionVisitorDependencies dependencies,
        ElasticQueryCompilationContext queryCompilationContext,
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    protected ElasticQueryableMethodTranslatingExpressionVisitor(
        ElasticQueryableMethodTranslatingExpressionVisitor parentVisitor)
    ...
    public override Expression Translate(Expression expression)
    {
            ...
            && method.Name is nameof(CosmosQueryableExtensions.ToPageAsync))
        {
            if (_subquery)
            {
                AddTranslationErrorDetails("ToPageAsyncAtTopLevelOnly");
            ...
            return shapedQuery
                .UpdateShaperExpression(
                    new PagingExpression(
                        ...
                        translatedResponseContinuationTokenLimitInKb,
                        typeof(ElasticPage<>).MakeGenericType(shapedQuery.ShaperExpression.Type)))
...
#pragma warning restore EF1001 // Internal EF Core API usage.
    ...
    protected override QueryableMethodTranslatingExpressionVisitor CreateSubqueryVisitor()
        => new ElasticQueryableMethodTranslatingExpressionVisitor(this);
    ...
    protected override ShapedQueryExpression? CreateShapedQueryExpression(IEntityType entityType)
    {
        ...
        if (concreteEntityTypes is [var singleEntityType]
            ...
            && entityType.GetIndexName() is var container
            && !entityType.Model.GetEntityTypes().Any(
                ...
                e => e.GetIndexName() == container && !Equals(e.GetDiscriminatorValue(), singleEntityType.GetDiscriminatorValue())))
        {
