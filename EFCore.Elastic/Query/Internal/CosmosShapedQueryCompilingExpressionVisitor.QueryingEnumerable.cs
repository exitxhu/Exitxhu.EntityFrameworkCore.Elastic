    ...
    private sealed class QueryingEnumerable<T> : IEnumerable<T>, IAsyncEnumerable<T>, IQueryingEnumerable
    {
        ...
        private sealed class Enumerator : IEnumerator<T>
        {
            ...
            public Enumerator(QueryingEnumerable<T> queryingEnumerable)
            {
                ...
                _elasticQueryContext = queryingEnumerable._cosmosQueryContext;
                _shaper = queryingEnumerable._shaper;
                _contextType = queryingEnumerable._contextType;
                _cosmosContainer = queryingEnumerable._cosmosContainer;
                _queryLogger = queryingEnumerable._queryLogger;
                _standAloneStateManager = queryingEnumerable._standAloneStateManager;
                _exceptionDetector = _elasticQueryContext.ExceptionDetector;

                _concurrencyDetector = queryingEnumerable._threadSafetyChecksEnabled
                    ? _elasticQueryContext.ConcurrencyDetector
                    : null;
            }
            ...
            public bool MoveNext()
            {
                try
                {
                    ...
                    if (_enumerator == null)
                    {
                        ...
                        _enumerator = _elasticQueryContext.ElasticClient
                            .ExecuteSqlQuery(_cosmosContainer, sqlQuery)
                            .GetEnumerator();
                        _elasticQueryContext.InitializeStateManager(_standAloneStateManager);
                    }
                    ...
                    Current
                        = hasNext
                            ? _shaper(_elasticQueryContext, _enumerator.Current)
                            : default;
            ...
            public async ValueTask<bool> MoveNextAsync()
            {
                try
                {
                    ...
                    if (_enumerator == null)
                    {
                        ...
                        _enumerator = _cosmosQueryContext.ElasticClient
                            .ExecuteSqlQueryAsync(_cosmosContainer, sqlQuery)
