...
public class CosmosProjectionBindingExpressionVisitor : ExpressionVisitor
{
    ...
    private readonly ElasticQueryableMethodTranslatingExpressionVisitor _queryableMethodTranslatingExpressionVisitor;
    ...
    public CosmosProjectionBindingExpressionVisitor(
        IModel model,
        ElasticQueryableMethodTranslatingExpressionVisitor queryableMethodTranslatingExpressionVisitor,
