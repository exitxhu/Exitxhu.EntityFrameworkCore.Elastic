    ...
    : ISqlExpressionFactory
{
        ...
        CoreTypeMapping? typeMapping)
    {
        ...
        switch (sqlUnaryExpression.OperatorType)
        {
            ...
            default:
                throw new InvalidOperationException($"{sqlUnaryExpression.OperatorType}, {typeof(SqlUnaryExpression).ShortDisplayName()}");
        }
        ...
        CoreTypeMapping? typeMapping)
    {
        ...
        switch (sqlBinaryExpression.OperatorType)
        {
            ...
            default:
                throw new InvalidOperationException($"{sqlBinaryExpression.OperatorType}, {typeof(SqlBinaryExpression).ShortDisplayName()}");
        }
